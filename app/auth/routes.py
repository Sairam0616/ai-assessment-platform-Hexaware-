from .schemas import CandidateLoginSchema, EducatorLoginSchema
from fastapi import APIRouter, HTTPException, status
from app.auth.utils import authenticate_user, create_access_token, get_password_hash
from app.auth.schemas import AdminLoginSchema, CandidateRegisterSchema, TokenSchema
...
async def register_candidate(candidate_data: CandidateRegisterSchema):
    ...
    await candidate_collection.insert_one(candidate_data.dict())
